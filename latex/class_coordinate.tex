...
\subsubsection[{Coordinate}]{\setlength{\rightskip}{0pt plus 5cm}Coordinate\-::\-Coordinate (
\begin{DoxyParamCaption}
\item[{{\bf Vector}}]{place, }
\item[{const {\bf City} $\ast$const}]{ort}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\label{class_coordinate_aa299c35ffbf14f830e03f295bb00ffbe}
This constructor creates a coordinate with city on it. \index{Coordinate@{Coordinate}!Coordinate@{Coordinate}}
\index{Coordinate@{Coordinate}!Coordinate@{Coordinate}}
\subsubsection[{Coordinate}]{\setlength{\rightskip}{0pt plus 5cm}Coordinate\-::\-Coordinate (
\begin{DoxyParamCaption}
\item[{short}]{x, }
