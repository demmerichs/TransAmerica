...
const std::string BRETTNAME="hdr/game/boardSettings/standard/";
...
enum PLAYERCOLOR{P_BLUE,P_GREEN,P_ORANGE,P_VIOLET,P_WHITE,P_YELLOW,NORAILS};
const PLAYERCOLOR PLAYERCOLOUR_LIST[]={P_BLUE,P_GREEN,P_ORANGE,P_VIOLET,P_WHITE,P_YELLOW};
